    ...
    <div class="layui-row">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea placeholder="请输入内容" class="layui-textarea" name="describe_name"></textarea>
                </div>
            </div>
    ...
    layui.use(['form', 'layer','jquery'],
        function() {
            ...
            form.on('submit(add)', function(data) {
                ...
                $.post("{{url('permission')}}",{data:data.field,_token:"{{csrf_token()}}",form_token:form_token},function (res) {
