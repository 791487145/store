    ...
    <div class="layui-row">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="is_show" lay-filter="aihao">
                        ...
                        <option value="1" @if($menu->is_show == 1) selected @endif>启用</option>
                        <option value="2" @if($menu->is_show == 2) selected @endif>禁用</option>
                    </select>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="is_menu" lay-filter="aihao">
                        <option value="0" >请选择</option>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea placeholder="请输入内容" class="layui-textarea" name="describe_name">{{$menu->describe_name}}</textarea>
                </div>
            </div>
    ...
    layui.use(['form', 'layer','jquery'],
        function() {
            ...
            form.on('submit(add)', function(data) {
                ...
                $.post("{{url('permission/update')}}",{data:data.field,_token:"{{csrf_token()}}",form_token:form_token},function (res) {
