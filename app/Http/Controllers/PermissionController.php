...
class PermissionController extends BaiscController
{
    private $service;

    public function __construct(PermissionServices $service)
    {
    ...
    public function create()
    {
        ...
        return view('permission/permission_add',['data'=>$data]);
    }
    ...
    public function show($id)
    {
        ...
        return view('permission/permission_edit',['tree'=>$tree,'menu'=>$menu]);
    }
